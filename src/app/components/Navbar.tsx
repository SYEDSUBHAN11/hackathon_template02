...
const Navbar = () => {
  ...
  return (
    <div className="p-0 m-0 w-full h-auto mt-0"> {/* Ensure no margin */}
      {/* Top Section */}
      <div className="flex justify-between items-center py-2 relative">
        ...
        {/* Underline from Search to Account Icons */}
        <div className="absolute left-0 right-0 bottom-0 h-[1px] bg-[#726E8D] md:hidden" />
      </div>

      <hr className="border-t-0" /> {/* Optional: Remove border if not needed */}
